...
class PerformanceHorizontal extends Component{
	render () {
    ...
    if(!this.props.book){
      ...
      <div>
				<div>
				<h3 className='subtitles'>Performance Over IE Forecast</h3>
				</div>
				<div className="row">
          ...
          <div className="col-sm-6 right-col-text commentary-title">
						...
						<p className='commentary'> <strong>{this.props.book.title}</strong> has lost {this.props.book.data[0].Difference} MWh due to suboptimal operation.</p>
					</div>
				</div>
	    </div>
    );
...
export default connect(mapStateToProps)(PerformanceHorizontal);
